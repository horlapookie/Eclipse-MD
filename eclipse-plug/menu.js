...
// Hardcoded total command count (500+ including aliases)
...
const buttonMessage = {
  ...
  contextInfo: {
    ...
    mentionedJid: msg.key.remoteJid.includes('g.us') ? [] : undefined
  },
  templateButtons: [
    {
      index: 1,
    ...
    try {
      ...
      console.log('[MENU] Error sending menu with buttons:', error.message);
